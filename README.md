...
3 atividade do núcleo web (básico) na InfoJr - UFBA 

Meu primeiro contato com javascript numa landing page. Utilizei a interface DOM, implementação do menu mobile (hamburguer). Layout responsivo
